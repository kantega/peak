...
public abstract class ResponseBuilder {
    ...
    public ResponseBuilder or(F<Exception,ResponseBuilder> other) {
    ...
    static class OnExceptionResponseBuilder extends ResponseBuilder {
        ...
        private final F<Exception, ResponseBuilder> errorHandler;

        OnExceptionResponseBuilder(ResponseBuilder wrapped, F<Exception, ResponseBuilder> errorHandler) {
