...
public class Request {
	...
	public static F<Part, Option<String>> partToString() {
		return new F<Part, Option<String>>() {
	...
	public static F<Part, Option<FileUpload>> partToFile() {
		return new F<Part, Option<FileUpload>>() {
